Feature: Open Hugosave Account

  Scenario: Open User Account
  ...
  Scenario: Cash Wallet status for L0 user
    ...
    Then I get the user cash wallets for the user UID1 and expect the account status of CASH_ACCOUNT_STATUS_INACTIVE