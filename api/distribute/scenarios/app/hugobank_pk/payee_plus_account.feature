Feature: Payee scenarios for a PLUS account

  Background: Create 2 HUGOBANK PLUS accounts to test payee scenarios
  ...
  Scenario: Add Payee, Pay Payee
    ...
    Then I transfer 60000 PKR from user UID1 to user UID2 with no reference and valid payee id and expect a status code of 200
    ...
    And I check the balance of the wallet with product code CASH_WALLET_CURRENT for user UID2 and the balance should be 60000 PKR exact
  ...
  Scenario: Pay Payee Using Static QR code
    ...
    Then I transfer 60000 PKR from user UID1 to user UID2 using Static QR code
  ...
  Scenario: Pay Payee Using Dynamic QR code
    ...
    Given I create dynamic QR code with amount 70000 PKR for user UID2

    Then I get the user cash wallets for the user UID1 and expect the account status of CASH_ACCOUNT_STATUS_CREATED

    Given I deposit 80000 PKR into wallet with product code CASH_WALLET_CURRENT for user UID1 and expect a status code of 200

    And I check the balance of the wallet with product code CASH_WALLET_CURRENT for user UID1 and the balance should be 80000 PKR exact
    ...
    Then I transfer 70000 PKR from user UID1 to user UID2 using Dynamic QR code

    And I check the balance of the wallet with product code CASH_WALLET_CURRENT for user UID1 and the balance should be 10000 PKR exact

    And I check the balance of the wallet with product code CASH_WALLET_CURRENT for user UID2 and the balance should be 70000 PKR exact
