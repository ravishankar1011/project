Feature: Device Tokens for PLUS user

  Background: Create a HUGOBANK PLUS account
  ...
  Scenario: Device Tokens - Push, List, Delete
    ...
    Then I initiate the final user authorisation to DISABLE_NOTIFICATIONS and expect a user authorisation status as USER_AUTHORISATION_SUCCESS for user UID1
