Feature: Update user passcode for a HUGOBANK PLUS Account
  ...
  Scenario: Update the PREMIUM user Passcode
    ...
    And I initiate the HUGOBANK_BIO_VERISYS journey within the BIOMETRIC_VERIFICATION_STEP for user UID1 to authorise the user and expect a status JOURNEY_INITIATED
