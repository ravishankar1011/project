Feature: Virtual Cards scenario for PLUS account
  ...
  Scenario: Virtual Card transactions with updated limits for PLUS account
    ...
    Then I deposit 2100000 PKR into wallet with product code CASH_WALLET_CURRENT for user UID1 and expect a status code of 200
    ...
    And I update the Gold Rewards Card limit of channel E_COMMERCE to 300000 PKR for user UID1 and expect a status code of 200

    Then I check if the Gold Rewards Card limit for the E_COMMERCE channel is set to 300000 PKR for user UID1

    Given I create below transaction for VIRTUAL card for user profile id and expect a status code of 200
      | user_profile_identifier | transaction_permutation_name | billing_amount | is_foreign_txn | channel    |
      | UID1                    | AUTH_CLEAR                   | 305000         | false          | E_COMMERCE |

    And I check the balance of the wallet with product code CASH_WALLET_CURRENT for user UID1 and the balance should be 2000000 PKR exact

    Given I create below transaction for VIRTUAL card for user profile id and expect a status code of 200
      | user_profile_identifier | transaction_permutation_name | billing_amount | is_foreign_txn | channel    |
      | UID1                    | AUTH_CLEAR                   | 300000         | false          | E_COMMERCE |

    And I check the balance of the wallet with product code CASH_WALLET_CURRENT for user UID1 and the balance should be 1700000 PKR exact
    ...
    And I update the Gold Rewards Card limit of channel E_COMMERCE to 400000 PKR for user UID1 and expect a status code of 200

    Then I check if the Gold Rewards Card limit for the E_COMMERCE channel is set to 400000 PKR for user UID1

    Given I create below transaction for VIRTUAL card for user profile id and expect a status code of 200
      | user_profile_identifier | transaction_permutation_name | billing_amount | is_foreign_txn | channel    |
      | UID1                    | AUTH_CLEAR                   | 100000         | false          | E_COMMERCE |

    And I check the balance of the wallet with product code CASH_WALLET_CURRENT for user UID1 and the balance should be 1600000 PKR exact
