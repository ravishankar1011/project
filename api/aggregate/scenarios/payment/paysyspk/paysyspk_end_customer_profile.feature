Feature: Payment Service EndCustomerProfileOnboarding Scenarios for provider Paysys
...
#    Examples:
#      | customer_profile_id | end_customer_profile_id | status_code | request_origin | on_behalf_of |
#      | PSCPID1             | ECPID1                  | PTM_2003   | CARD           | CUSTOMER     |
#      | PSCPID1             | ECPID1                  | PTM_2003   | INVESTMENT     | CUSTOMER     |
