Feature: Cautious Portfolio module
  Background:
  ...
  Scenario: I buy cautious fund with balance in the save account
    When I move to the cautious dashboard from the homescreen
