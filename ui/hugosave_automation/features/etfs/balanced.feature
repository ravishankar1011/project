Feature: Balanced Portfolio module
  Background:
  ...
  Scenario: I buy balanced fund with balance in the save account
    When I move to the balanced dashboard from the homescreen
